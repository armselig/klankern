...
- Resolved password validation error on user update by making the password field truly optional in frontend validation and ensuring the backend handles optional password updates.
