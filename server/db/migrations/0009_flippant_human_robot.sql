...
--> statement-breakpoint
ALTER TABLE "users" DROP CONSTRAINT "users_email_verification_token_unique";--> statement-breakpoint
DROP INDEX "users_email_verification_token_idx";--> statement-breakpoint
