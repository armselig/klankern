...
CREATE INDEX "corkboard_posts_family_timeline_idx" ON "corkboard_posts" USING btree ("family_id","created_at");--> statement-breakpoint
CREATE INDEX "corkboard_posts_data_gin_idx" ON "corkboard_posts" USING gin ("data");--> statement-breakpoint
CREATE INDEX "families_active_idx" ON "families" USING btree ("created_at") WHERE deleted_at IS NULL;--> statement-breakpoint
CREATE INDEX "family_invitations_family_status_idx" ON "family_invitations" USING btree ("family_id","status");--> statement-breakpoint
CREATE INDEX "family_invitations_pending_idx" ON "family_invitations" USING btree ("family_id","invited_email") WHERE status = 'pending';--> statement-breakpoint
...
CREATE INDEX "users_dashboard_config_gin_idx" ON "users" USING gin ("dashboard_config");